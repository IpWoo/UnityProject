	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = float4( ase_worldViewDir , 0.0 );
				return finalColor;
			}
			ENDCG
		}
